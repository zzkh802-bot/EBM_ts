...
4. Add evidence only from exact source quotes with stable line offsets.
...
3. Archive sources.
4. Add exact-quote evidence JSON.
5. Draft report with citations pointing to evidence nodes.
