...
<template>
  <aside class="gemini-rail" aria-label="循医快速导航">
    ...
    <nav class="workspace-nav" aria-label="工作台一级导航">
      <button class="nav-item workspace-nav-item" :class="{ active: isActive('/evidence') }" type="button" aria-label="循证研究" @click="go('/evidence')">
      ...
      <button class="nav-item workspace-nav-item" :class="{ active: isActive('/knowledge') }" type="button" aria-label="研究报告库" @click="go('/knowledge')">
