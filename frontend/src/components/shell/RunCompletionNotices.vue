...
.run-completion-notice { display: flex; align-items: stretch; overflow: hidden; border: 1px solid rgba(49, 86, 200, .24); border-radius: 12px; background: var(--paper-bright, #fff); box-shadow: 0 14px 38px rgba(20, 42, 74, .18); pointer-events: auto; animation: run-completion-in .25s ease both; }
...
.run-completion-main:hover { background: rgba(49, 86, 200, .045); }
.run-completion-icon { display: grid; width: 26px; height: 26px; flex: 0 0 auto; place-items: center; border-radius: 50%; background: var(--jade, #3156c8); color: #fff; font-size: 15px; font-weight: 700; }
...
.run-completion-copy em { color: var(--jade, #3156c8); font-size: 11px; font-style: normal; }
...
.run-completion-close:hover { background: rgba(49, 86, 200, .06); color: var(--ink, #172535); }
