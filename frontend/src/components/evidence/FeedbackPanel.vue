...
<style scoped>
.feedback-panel { margin-top: 18px; padding: 14px 15px; border: 1px solid rgba(49, 123, 107, .2); border-radius: 10px; background: rgba(238, 247, 243, .62); }
...
.feedback-scale button { min-width: 34px; padding: 4px 7px; border: 1px solid rgba(49, 123, 107, .22); border-radius: 5px; background: rgba(255, 255, 255, .7); color: var(--ink-soft, #56636f); cursor: pointer; }
