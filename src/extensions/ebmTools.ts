...
export function registerEbmTools(pi: ExtensionAPI): void {
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "Make both boundaries distinctive: include nearby section context, claim-specific wording, and any relevant number/unit; prefer roughly 12–40+ characters per boundary. Avoid generic repeated markers such as 'Results', 'Conclusion', '推荐' or '(证据等级 2b)'. If multiple matches are reported, lengthen the boundaries or narrow the read/line range before retrying.",
