...
| `pubmed_search` | One search snapshot plus one citation-capable `sources/read/` archive per complete PubMed abstract; similar-article hints remain discovery-only |
